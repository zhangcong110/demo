            ...
            <?php foreach($user as $v):?>
                <tr>
                    <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="" />
                        <?= $v['id']?></td>
                    <td><?= $v['username']?></td>
                    <td width="10%"><img src="<?= $v['via']?>" alt="" width="70" height="50" /></td>
                    <td><?= $v['name']?></td>
                    <td><?= $v['email']?></td>
                    <td><?= date('Y-m-d H:i:s',$v['created_at'])?></td>
                    <td><?= date('Y-m-d H:i:s',$v['updated_at'])?></td>
                    <td><div class="button-group"> <a class="button border-main" href="<?php echo site_url('Admin/User/userRoleAdd?id='.$v['id'])?>"><span class="icon-edit"></span>角色</a>
