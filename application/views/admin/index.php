...
<div class="leftnav">
    ...
    <h2><span class="icon-user"></span><?= $v['name']?></h2>
    <ul style="display:block">
        <?php foreach($v['access'] as $va):?>
        <li><a href="<?php echo site_url("Admin/".$va['route']);?>" target="right"><span class="icon-caret-right"></span><?= $va['title']?></a></li>
        <?php endforeach;?>
    </ul>
    <?php endforeach;?>
</div>
