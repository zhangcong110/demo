            ...
            <?php foreach($data as $v):?>
                <tr>
                    <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="" />
                        <?= $v['id']?></td>
                    <td><?= $v['title']?></td>
                    <td width="10%"><?= $v['route']?></td>
                    <td>
                        <?php if($v['status']==1):?>
                            <a class="button border-main" href="javascript:void(0)"><span class="icon-edit"></span>停用</a>
                            <?php else: ?>
                            <a class="button border-main" href="javascript:void(0)"><span class="icon-edit"></span>启用</a>
                        <?php endif;?>
                    </td>

                    <td><font color="#00CC99"><?= date('Y-m-d H:i:s',$v['add_time'])?></font></td>
                    <td><?= $v['update_time']?></td>
