...
<div class="banner">
    ...
    <div class="login-aside">
        ...
        <div id="o-box-down"  style="table-layout:fixed;">
            ...
            <form class="registerform"action="<?php echo site_url('Admin/Index/index?submit=c')?>" method="post">
                <div class="fm-item">
                    <label for="logonId" class="form-label">MISS系统登陆：</label>
                    <input type="text" placeholder="输入账号" name="username" maxlength="100" id="username" class="i-text" ajaxurl="demo/valid.jsp"  datatype="s6-18" errormsg="用户名至少6个字符,最多18个字符！"  >
...
<div class="footer">
    <p>西安华软 版权所有    Copyright 2012-2013 HUARUAN Corporation, All Rights Reserved</p>
</div>
